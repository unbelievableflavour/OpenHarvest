...
namespace Tests
{
    public class BreakableDeadTree2Test
    {
        ...
        public void SetUp()
        {
            var prefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Components/_Etc/BreakableTree/DeadTree/BreakableDeadTree2.prefab");
