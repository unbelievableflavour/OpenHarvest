...
namespace Tests
{
    public class BreakableDeadTree3Test
    {
        ...
        public void SetUp()
        {
            var prefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Components/_Etc/BreakableTree/DeadTree/BreakableDeadTree3.prefab");
