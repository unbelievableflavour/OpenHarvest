...
namespace Tests
{
    public class BreakableHighGrassTest
    {
        ...
        public void SetUp()
        {
            var prefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Components/_Etc/PatchBreakables/BreakableHighGrass.prefab");
