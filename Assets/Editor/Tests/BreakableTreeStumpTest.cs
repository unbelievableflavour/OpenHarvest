...
namespace Tests
{
    public class BreakableTreeStumpTest
    {
        ...
        public void SetUp()
        {
            var prefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Components/_Etc/PatchBreakables/BreakableTreeStump.prefab");
        ...
        public void ItCanBeChoppedDownWithATool()
        {
            ...
            var objectSpawner = breakable.GetComponentInChildren<ObjectSpawner>();
