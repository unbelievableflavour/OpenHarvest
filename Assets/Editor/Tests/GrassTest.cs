...
namespace Tests
{
    public class GrassTest
    {
        ...
        public void SetUp()
        {
            var prefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Components/_Etc/Grass/grass.prefab");
        ...
        public void ItChecksIfTheLODsAreConfigured()
        {
            ...
            Assert.AreEqual(1, gameObject.GetComponent<LODGroup>().GetLODs()[0].renderers.Length);
        }
