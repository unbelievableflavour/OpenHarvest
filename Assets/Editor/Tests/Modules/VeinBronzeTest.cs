...
namespace Modules
{
    public class VeinBronzeTest
    {
        ...
        public void SetUp()
        {
            var prefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/DungeonGenerator/Modules/Room/VeinBronze/VeinBronze.prefab");
        ...
        public void ItChecksIfBreakableObjectControllerIsConfiguredCorrectly()
        {
            ...
            Assert.AreEqual(4, breakableObjectController.health);
