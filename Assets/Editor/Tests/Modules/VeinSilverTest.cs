...
namespace Modules
{
    public class VeinSilverTest
    {
        ...
        public void SetUp()
        {
            var prefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/DungeonGenerator/Modules/Room/VeinSilver/VeinSilver.prefab");
        ...
        public void ItChecksIfBreakableObjectControllerIsConfiguredCorrectly()
        {
            ...
            Assert.AreEqual(6, breakableObjectController.health);
